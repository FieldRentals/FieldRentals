  ...
  return (
    <div className="FooterContainer">
      ...
      <div className="FooterContainerMidText">
        <Link className="FooterLinkText" to="/terms">Terms</Link>
      </div>
        <div className="FooterContainerMidText">
        <Link className="FooterLinkText" to="/PrivacyPolicy">Privacy Policy</Link>  
        </div>
        <div className="FooterContainerMidText">
        <Link className="FooterLinkText" to="/LN">Legal Notice</Link> 
        </div>
        <div className="FooterContainerMidText">
        <Link className="FooterLinkText" to="/Accesibility">Accesibility</Link> 
        </div>
      </div>
